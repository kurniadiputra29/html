          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <form action="" method="get">
                  <!-- <a href="http://localhost/perpus_masjid/admin/kategori_buku/create.php" class="btn btn-primary pull-right" disabled>Create</a> -->
                  <a href="http://localhost/perpus_masjid/admin/kartu_anggota/index.php" class="btn btn-default pull-right">Clear</a>
            ...
            <div class="box-body">
              <table class="table table-bordered">
               ...
               $sql    = "SELECT * FROM kartu_anggota WHERE id_anggota LIKE '%$cari%' ";
