            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <form action="" method="get">
                  <!-- <a href="http://localhost/perpus_masjid/admin/pendaftaran/create.php" class="btn btn-primary pull-right" disabled>Create</a> -->
                  <a href="http://localhost/perpus_masjid/admin/pendaftaran/index.php" class="btn btn-default pull-right">Clear</a>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <tr>
                    ...
                    <!-- <td>
                      ...
                      <a href='delete.php?id=<?= $row['id_pendaftaran'] ?>'onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")' class='btn btn-danger btn-xs'>Hapus</a>
                    </td> -->
                  </tr>
                  <?php
                }
