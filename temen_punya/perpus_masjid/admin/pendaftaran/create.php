...
$sql01    = "SELECT * FROM anggota";
$hasil1   = mysqli_query($connect,$sql01);
$sql02    = "SELECT * FROM kartu_anggota";
            ...
            <form class="form-horizontal" action="proses_insert.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> 
                    <!-- <input type="text" class="form-control" id="inputEmail3" placeholder="masukkan angka" name="no_identitas"> -->
                    <select class="form-control" name="no_identitas">
<?php while($dat = mysqli_fetch_assoc($hasil1)) {?>
                    <option value="<?php echo $dat['no_identitas']; ?>"><?php echo $dat['nama_anggota']; ?></option>
<?php } ?>
                    </select>
                  </div>
                </div>
...
<?php while($data = mysqli_fetch_assoc($hasil2)) {?>
                    <option value="<?php echo $data['id_anggota']; ?>"><?php echo $data['no_identitas']; ?></option>
<?php } ?>
                  </select>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <a href="http://localhost/perpus_masjid/admin/pendaftaran" class="btn btn-default">Cancel</a>
