      ...
      <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <a href="http://localhost/perpus_masjid/admin/anggota/create.php" class="btn btn-primary pull-right">Create</a>
                <a href="http://localhost/perpus_masjid/admin/anggota/index.php" class="btn btn-default pull-right">Clear</a>
...
$sql    = "SELECT * FROM anggota WHERE nama_anggota LIKE '%$cari%' ";
...
<tr>
  ...
  <td>
    <a href='edit.php?id=<?= $row['no_identitas'] ?>' class='btn btn-primary btn-xs'>Edit</a>
    <a href='delete.php?id=<?= $row['no_identitas'] ?>'onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")' class='btn btn-danger btn-xs'>Hapus</a>
  </td>
</tr>
<?php
  }
