...
$id   = $_GET['id'];
$sql2   = "SELECT * FROM kategori_buku WHERE id_kategori_buku=$id";
            ...
            <form class="form-horizontal" action="proses_edit.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['id_kategori_buku']?>" name="id_kategori_buku">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['nama_kategori_buku']?>" name="nama_kategori_buku">
                  </div>
                </div>
            </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="http://localhost/perpus_masjid/admin/kategori_buku" class="btn btn-default">Cancel</a>
