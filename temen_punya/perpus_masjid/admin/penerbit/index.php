      ...
      <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <a href="http://localhost/perpus_masjid/admin/penerbit/create.php" class="btn btn-primary pull-right">Create</a>
                <a href="http://localhost/perpus_masjid/admin/penerbit/index.php" class="btn btn-default pull-right">Clear</a>
...
$sql    = "SELECT * FROM penerbit WHERE nama_penerbit LIKE '%$cari%' ";
...
<tr>
  ...
  <td>
    <a href='edit.php?id=<?= $row['id_penerbit'] ?>' class='btn btn-primary btn-xs'>Edit</a>
    <a href='delete.php?id=<?= $row['id_penerbit'] ?>'onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")' class='btn btn-danger btn-xs'>Hapus</a>
  </td>
</tr>
<?php
  }
