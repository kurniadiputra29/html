...
$id   = $_GET['id'];
$sql2   = "SELECT * FROM pinjam_buku WHERE id_pinjam_buku=$id";
            ...
            <form class="form-horizontal" action="proses_edit.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['isbn']?>" name="isbn">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Pinjam</label>
                  <div class="col-sm-10"> 
                    <input type="date" class="form-control" id="inputEmail3" value="<?= $row['tgl_pinjam_buku']?>" name="tgl_pinjam_buku">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Kembali</label>
                  <div class="col-sm-10"> 
                    <input type="date" class="form-control" id="inputEmail3" value="<?= $row['tgl_kembali_buku']?>" name="tgl_kembali_buku">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Status Peminjaman</label>
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['status_pinjam_buku']?>" name="status_pinjam_buku">
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <a href="http://localhost/perpus_masjid/admin/pinjam_buku" class="btn btn-default">Cancel</a>
