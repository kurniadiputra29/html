...
$id   = $_GET['id'];
$sql2   = "SELECT * FROM kategori_majalah WHERE id_kategori_majalah=$id";
            ...
            <form class="form-horizontal" action="proses_edit.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['id_kategori_majalah']?>" name="id_kategori_majalah">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['nama_kategori_majalah']?>" name="nama_kategori_majalah">
                  </div>
                </div>
            </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="http://localhost/perpus_masjid/admin/kategori_majalah" class="btn btn-default">Cancel</a>
