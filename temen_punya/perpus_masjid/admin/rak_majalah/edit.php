      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="box">
            ...
            $id   = $_GET['id'];
            $sql2   = "SELECT * FROM rak_majalah WHERE id_rak_majalah=$id";
            ...
            <form class="form-horizontal" action="proses_edit.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['id_rak_majalah']?>" name="id_rak_majalah">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10"> 
                    <input type="text" class="form-control" id="inputEmail3" value="<?= $row['nama_rak_majalah']?>" name="nama_rak_majalah">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="http://localhost/perpus_masjid/admin/rak_majalah" class="btn btn-default">Cancel</a>
