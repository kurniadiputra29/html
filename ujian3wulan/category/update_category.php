...
font-family: sans-serif;
	...
	<div id="container">
		...
		<div id="header2">UPDATE CATEGORY</div>
		<div class="menu">
			<ul>
		...
		<div class="table">
				<ul>
				<li><a href="../category/index_category.php">BACK</a></li>
				</ul>
		<?php
		include '../koneksi.php';
		$ID     = $_GET['id'];
	...
	<form action="proses_update_category.php" method="POST">
		...
		<tr class="input">
			...
			<td><input type="text" name="nama" id="nama" value="<?php echo $row['name']; ?>" class="col-10-b col-s-10"></td>
		</tr>			
		<tr class="submit">
