...
$sql = "UPDATE ak4 SET nama_siswa='$nama_siswa', tahun_lulus='$tahun_lulus', tempat_tanggal_lahir='$tempat_tanggal_lahir', nis='$nis', jurusan='$jurusan', tempat_bekerja='$tempat_bekerja', tempat_kuliah='$tempat_kuliah', jurusan_kuliah='$jurusan_kuliah', bidang_usaha_pekerjaan='$bidang_usaha_pekerjaan', penghasilan='$penghasilan', keterangan='$keterangan' WHERE id='$ID'";
