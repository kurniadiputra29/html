...
@media only screen and (max-width: 768px) {
	...
	<div id="container">
		...
		<div class="table">
				<ul>
				<li><a href="tambah_category.php">INPUT</a></li>
				</ul>
				<table>
					<tr>
						<th>No</th>
					...
					include '../koneksi.php';
					$nomor	= 1;
					$sql    = "select * from tn2 order by nama_siswa";
					...
					if(mysqli_num_rows($result)>0){// jika nggak ada datanya maka while tidak di jalankan
						while ($row = mysqli_fetch_assoc($result)) {// untuk memunculkan dalam bentuk rapi, mengambil dan dijadikan erray associative
							...
							<tr>
								...
								<td>".$row['jurusan_kuliah']."</td>
								<td>".$row['bidang_usaha_pekerjaan']."</td>
