...
$sql = "INSERT INTO ak3 (no_absen, nama_siswa, tahun_lulus, tempat_tanggal_lahir, nis, jurusan, tempat_bekerja, tempat_kuliah, jurusan_kuliah, bidang_usaha_pekerjaan, penghasilan, keterangan) VALUES ('$no_absen', '$nama_siswa', '$tahun_lulus', '$tempat_tanggal_lahir', '$nis', '$jurusan', '$tempat_bekerja', '$tempat_kuliah', '$jurusan_kuliah', '$bidang_usaha_pekerjaan', '$penghasilan', '$keterangan')";
