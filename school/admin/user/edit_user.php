              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <span><img style="width: 100px; height: 100px" src="../foto_user/<?php echo $row['foto'];?>"</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="role_id" class="form-control" id="role_id" value="<?php echo $row['role_id']; ?>" required>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
