...
<div class="container">
	...
	<div class="main">
		<h1 class="judul2">INDEX PRODUK</h1>
		<ul>
		...
		if (mysqli_num_rows($result)>0){
			...
			echo "<tr>
							...
							<td><a href='edit.php?id=".$row['kode_produk']."'>Edit</a> |
									<a href='delete.php?id=".$row['kode_produk']."'onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")'>Hapus</a>			
							</td>
						</tr>";
			}
		}
