<html>
<head><title>Input Data Produk</title>
<meta charset="utf-8">
...
<div class="conteiner">
	...
	<div class="main">
		<h1 class="judul2">INPUT PRODUK</h1>
		<ul>
		...
		<form action="proses_tambah.php" method="POST">
			<table class="table">
				<tr>
					...
					<td>:</td>
				<td><input type="text" name="nama_produk" id="nama_produk" maxlength="30" required></td>
				</tr>
				<tr>
					<td><label for="jenis_produk">Jenis Produk</label></td>
					<td>:</td>
					<td><input type="text" name="jenis_produk" id="jenis_produk" maxlength="30" required></td>
				</tr>
				<tr>
					<td><label for="stock">Stock</label></td>
					<td>:</td>
					<td><input type="text" name="stock" id="stock" maxlength="11" required></td>
				</tr>
				<tr>
					<td><label for="harga">Harga</label></td>
					<td>:</td>
					<td><input type="text" name="harga" id="harga" maxlength="11"></td>
				</tr>
				<tr>
				<td></td>
				<td></td>
