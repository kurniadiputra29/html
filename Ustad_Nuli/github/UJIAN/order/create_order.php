...
font-family: sans-serif;
	...
	<div id="container">
		...
		<div class="table">
			...
			<form action="proses_input_order.php" method="POST">
				<table class="input">
				<tr>
					<td><label for="table">Table Number</label></td>
					<td><input type="text" name="table" id="table" class="col-10-b col-s-10" maxlength="10" required></td>
				</tr>
					<tr>	    
					  	<td><label for="item">Item</label></td>
					  	<td><select name="item" id="item" class="col-10-b col-s-10" maxlength="11" required><option value="">Select</option>
									<?php
									include '../koneksi.php';
				...
				<tr>
					...
					<td><input type="text" name="qty" id="qty" class="col-10-b col-s-10" maxlength="11" required></td>
				</tr>		
				<tr class="submit">
