...
font-family: sans-serif;
	...
	<div id="container">
		...
		<div id="header2">UPDATE ORDER</div>
		<div class="menu">
			<ul>
				<li><a href="../category/index_category.php" >Category</a></li>
				<li><a href="../item/index_item.php" >Item</a></li>
				<li id="aktive"><a href="../order/index_order.php" >Order</a></li>
			</ul>
		</div><!--menu-->
		<div class="table">
				<ul>
				<li><a href="../order/index_order.php">Back</a></li>
				</ul>
			<?php
			include '../koneksi.php';
			$ID				= $_GET['id'];
			...
			$tampil		= $row['item_id'];
			$sql1    	= "select * from item where id=$tampil";
		...
		<form action="proses_edit_order.php" method="POST">
			...
			<tr><input type="hidden" name="id" value="<?php echo $ID; ?> " >
				...
				<td><input type="text" name="table" id="table" value="<?php echo $row['table_number']; ?>" maxlength="10" ></td>
			</tr>
				<tr>    
			    	<td><label for="item">Item</label></td>
			    	<td><select name="item" id="item" maxlength="11">
								<?php
								echo "
										<option value=".$tampil.">
											".$select."
								...
								$result2 = mysqli_query($connect,$sql2);// untuk menghubungkan databases melalui $connect dengan isinya melalui $sql tetapi masih acak
			...
			<tr>
				...
				<td><input type="text" name="qty" id="qty" value="<?php echo $row['qty']; ?>" maxlength="11" ></td>
			</tr>		
			<tr class="submit">
