...
font-family: sans-serif;
	...
	<div id="container">
		...
		<div id="header2">UPDATE ITEM</div>
		<div class="menu">
			<ul>
		...
		<form action="proses_edit_item.php" method="POST">
			<table class="input">
				<tr><input type="hidden" name="id" value="<?php echo $ID; ?> " >	    
			    	...
			    	<td><select name="category" id="category" maxlength="11">
								<?php
										echo "
								...
								$result1 = mysqli_query($connect,$sql1);// untuk menghubungkan databases melalui $connect dengan isinya melalui $sql tetapi masih acak
			...
			<tr>
				...
				<td><input type="text" name="nama" id="nama" value="<?php echo $row['name']; ?>" maxlength="100"></td>
			</tr>	
			<tr>
				<td><label for="price">Price</label></td>
				<td><input type="text" name="price" id="price" value="<?php echo $row['price']; ?>" maxlength="11"></td>
			</tr>	
			<tr class="radio">
				<td><label>Status</label></td>
				<td><input type="radio" name="status" id="status1" value="1" <?php if($row['status']=="1"){echo "checked";}?>/>
						<label for="status1">Aktif</label>
						<input type="radio" name="status" id="status2" value="0" <?php if($row['status']=="0"){echo "checked";}?>/>
